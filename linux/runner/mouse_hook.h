...
// Callback invoked when the right mouse button is held for two seconds.
// x and y are the current root-window pointer coordinates.
typedef void (*MouseHookRightHoldCallback)(int x, int y, gpointer user_data);
